...
\begin{figure}[H]
  \centering
  \subfloat[Kuka Kr210 in starting position.]{\includegraphics[width=0.49\textwidth]{kuka_start_position_new.png}\label{fig:kuka_start_position}}
  \hfill
  \subfloat[Kuka Kr210 after moving every joint to 0.5 rads]{\includegraphics[width=0.49\textwidth]{kuka_end_position1_new.png}\label{fig:kuka_end_position1}}
...
\section{Conclusion}
This thesis explored the application of the Double Q-Learning algorithm to a simulated robotic arm in a reinforcement learning setting. The theoretical foundation of the algorithm was introduced, implemented, and applied to a simple task using the Gazebo simulator and ROS2 libraries. The experimental results show that the Double Q-Learning algorithm works as the simulated arm learns to touch the can. This work contributes to the development of reinforcement learning algorithms for training robotic arms and provides not only a robust and efficient approach but also an alternative to solving complex tasks in the robotics area.
...
Regarding the simulated environment setup, a docker implementation of the whole reinforcement learning framework created in this thesis could be done since installing ROS2, Gazebo, and making them work together is not a straightforward process.
...
%\begin{tcolorbox}[breakable, title=Titulo]\label{box:code}
