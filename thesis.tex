...
\begin{minted}[fontsize=\scriptsize,linenos=false,bgcolor=white]{bash}
...
\begin{figure}[H]
  \centering
  \subfloat[Sum of rewards in an episode or episode reward per episode.]{\label{rewards_episodes_800_gamma_05}\includegraphics[width=0.99\textwidth]{rewards_episodes_800_gamma_05.png}}\\
  \subfloat[Number of steps per episode.]{\label{nSteps_episodes_800_gamma_05}\includegraphics[width=0.99\textwidth]{nSteps_episodes_800_gamma_05.png}} \\
  \subfloat[Exploration rate ($\epsilon$) value at the beginning of each episode.]{\label{epsilon_episodes_800_gamma_05}\includegraphics[width=0.99\textwidth]{epsilon_episodes_800_gamma_05.png}}
